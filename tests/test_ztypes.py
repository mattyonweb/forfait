...
from forfait.ztypes.ztypes import ZTFunction, ZTBase, ZTGeneric, type_of_application_rowpoly, ztfunc, ztfuncexp, \
    ZTRowGeneric
...
class TestFunctionApplication_nopoly(TestCase):
    ...
    def test_lr_longer_rl(self):
        T = ZTRowGeneric("T")
        f1 = ztfuncexp(T, [ZTBase.U8], T, [ZTBase.U8, ZTBase.U16, ZTBase.BOOL])

        A = ZTRowGeneric("A")
        f2 = ztfuncexp(A, [ZTBase.BOOL], A, [ZTBase.S8])

        self.assert_type(f1, f2, "(''T U8 -> ''T U8 U16 S8)")

    def test_rl_longer_lr(self):
        A = ZTRowGeneric("A")
        f1 = ztfuncexp(A, [ZTBase.U8], A, [ZTBase.U16])

        T = ZTRowGeneric("T")
        f2 = ztfuncexp(T, [ZTBase.BOOL, ZTBase.BOOL, ZTBase.U16], T, [ZTBase.S8])
    ...
    def test_rl_equal_lr(self):
        T = ZTRowGeneric("T")
        A = ZTRowGeneric("A")
        f1 = ztfuncexp(T, [ZTBase.U8], T, [ZTBase.U16, ZTBase.S8])
        f2 = ztfuncexp(A, [ZTBase.U16, ZTBase.S8], A, [ZTBase.BOOL])
        self.assert_type(f1, f2, "(''A U8 -> ''A BOOL)")

    def test_two_consecutive_numbers(self):
        T = ZTRowGeneric("T")
        A = ZTRowGeneric("A")
        f1 = ztfuncexp(A, [], A, [ZTBase.U8])
        f2 = ztfuncexp(T, [], T, [ZTBase.U8])
        self.assert_type(f1, f2, "(''A -> ''A U8 U8)")

    def test_fail(self):
        T = ZTRowGeneric("T")
        A = ZTRowGeneric("A")
        f1 = ztfuncexp(T, [ZTBase.U8], T, [ZTBase.U16])
        f2 = ztfuncexp(A, [ZTBase.S8], A, [ZTBase.BOOL])
...
class TestFunctionApplication_polymorphism(TestCase):
    ...
    def test_global_poly1(self):
        ...
        A = ZTGeneric("A")
        dup  = ztfuncexp(T1, [A], T1, [A, A])
        add1 = ztfuncexp(T2, [ZTBase.U8, ZTBase.U8], T2, [ZTBase.U8])
    ...
    def test_global_poly2_remains_generic(self):
        ...
        B = ZTGeneric("B")
        X = ZTGeneric("X")
        swap = ztfuncexp(T1, [A, B], T1, [B, A])
        dup  = ztfuncexp(T2, [X], T2, [X, X])
    ...
    def test_global_poly3_hof(self):
        ...
        B = ZTGeneric("B")
        f1 = ztfuncexp(
            T1, [ztfuncexp(T2, [A], T2, [ZTBase.U8]), B, A],
            T1, [A, B]
        )
        f2 = ztfuncexp(T3, [ZTBase.U16, ZTBase.BOOL], T3, [ZTBase.S8])
    ...
    def test_global_quote_eval_nogenerics(self):
        ...
        double_add_quoted = ztfuncexp(
            S, [],
            S, [ztfuncexp(R, [ZTBase.U8,ZTBase.U8,ZTBase.U8], R, [ZTBase.U8])]
        )
        eval_ = ztfuncexp(
            A, [ztfuncexp(A, [], B, [])],
            B, []
